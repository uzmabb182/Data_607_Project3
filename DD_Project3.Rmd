...
rec.skillscat <-ggplot(rec, aes(skill_category ,n, fill = skill_category) ) + geom_col() + facet_grid(rows = vars(RecommendationID), scales= "free_y", switch = "y", space = "free_y") + coord_flip() + labs(x = "RecommendationID", y = "Count") + 
...
The smallest group of skills mentioned in both job postings and recommendation sites was Languages, with SQL, Python, Java and C++ as the top 4.  SQL was the top Language seen in the job postings, with Python and Java(script) also seen frequently.  The recommedations added R to this list.   
